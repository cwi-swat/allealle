module tests::SudokuGenerator

import IO;
import List;

void generateKodkodSudoku() =
  generateSudoku({<1,1,6>,<1,4,2>,<1,8,5>,<2,2,1>,<2,3,8>,<2,5,6>,<2,8,2>,<3,3,3>,<3,7,4>,<4,4,6>,<4,6,7>,<4,7,8>,<5,1,4>,<5,3,2>,<5,5,5>,
...
void generateHardSudoku() = 
  ...
  generateSudoku({<1,1,2>,<1,2,6>,<1,6,9>,<1,8,3>,<2,3,1>,<2,6,2>,<2,7,5>,<3,5,8>,<3,9,6>,<4,2,7>,<4,4,8>,<4,5,6>,<5,4,9>,<5,6,4>,
                  <6,5,5>,<6,6,3>,<6,8,4>,<7,1,9>,<7,5,7>,<8,3,3>,<8,4,2>,<8,7,9>,<9,2,2>,<9,4,4>,<9,8,8>,<9,9,1>}, 
                 |project://allealle/examples/|);   

void generateSudoku(rel[int, int, int] filledInCells, loc locationToSave) {
