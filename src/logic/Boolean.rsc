...
//
//@memo Formula \and({\true(), *Formula r})				      = \and(r);
//@memo Formula \and({\false(), *Formula _}) 			      = \false();
//@memo Formula \and({*Formula a, and(set[Formula] b)}) = \and(a + b);
//@memo Formula \and({Formula g,\not(g),*Formula r}) 	  = \false();
//
//@memo Formula \and({Formula g, \or({not(g), *Formula ro}), *Formula ra}) = \and({g,\or(ro)} + ra);  
//@memo Formula \and({not(Formula g), \or({g, *Formula ro}), *Formula ra}) = \and({not(g),\or(ro)} + ra);  
...
Formula \and(Formula _, Formula b)                    = \false();
