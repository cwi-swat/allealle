...
test bool unionCompatibleRelationsCanBeDifferenced() {
  ...
  return difference(r1,r2) == create("result", ("id":id())).t(("id":lit(id("r1")))).build();
}
...
test bool optionalRowsTrumpMandatoryRows() {
  ...
  return difference(r1,r2) == create("result", ("id":id())).f(("id":lit(id("r1"))), not(pvar("rel2_r1")), \true()).build();
}

test bool optionalRowsTrumpMandatoryRowsPartTwo() {
  Relation r1 = create("rel1", ("id":id())).v(("id":lit(id("r1")))).build();
  Relation r2 = create("rel2", ("id":id())).t(("id":lit(id("r1")))).build();
...
test bool onEqualRows_rowOfRhsRelationMustNotExists() {
  ...
  return difference(r1,r2) == create("result", ("id":id())).f(("id":lit(id("r1"))), \and(pvar("rel1_r1"),not(pvar("rel2_r1"))), \true()).build();
}

test bool differenceOfNonOptionalRowsMustHaveExactSameAttributeValues() {
  Relation r1 = create("rel1", ("id":id(),"num":Domain::\int())).t(("id":lit(id("r1")),"num":lit(\int(10)))).build();
  Relation r2 = create("rel2", ("id":id(),"num":Domain::\int())).t(("id":lit(id("r1")),"num":lit(\int(10)))).build();
...
test bool differenceOfRowsMustHaveExactSameAttributeValues() {
  Relation r1 = create("rel1", ("id":id(),"num":Domain::\int())).v(("id":lit(id("r1")),"num":lit(\int(20)))).build();
  Relation r2 = create("rel2", ("id":id(),"num":Domain::\int())).v(("id":lit(id("r1")),"num":lit(\int(10)))).build();
  
  return difference(r1,r2) == create("result", ("id":id(),"num":Domain::\int())).f(("id":lit(id("r1")),"num":lit(\int(20))), pvar("rel1_r1"), \true()).build();
}

test bool differenceOfRowsMustHaveExactSameAttributeValuesAlsoWhenTheyAreVariable() {
  Relation r1 = create("rel1", ("id":id(),"num":Domain::\int())).v(("id":lit(id("r1")),"num":var("n1",Sort::\int()))).build();
  Relation r2 = create("rel2", ("id":id(),"num":Domain::\int())).v(("id":lit(id("r1")),"num":var("n2",Sort::\int()))).build();
  
  return difference(r1,r2) == create("result", ("id":id(),"num":Domain::\int())).f(("id":lit(id("r1")),"num":var("n1",Sort::\int())), pvar("rel1_r1"), \or(not(pvar("rel2_r1")),not(equal(var("n1",Sort::\int()),var("n2",Sort::\int()))))).build();
}
